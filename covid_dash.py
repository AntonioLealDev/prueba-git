...
#Trozo de código 2
def​ convertTime(t): t = int(t)
​return​ datetime.fromtimestamp(t)
      
df_final = df_final.dropna(subset=[​"Last_Update"​]) df_final[​"Province_State"​].fillna(value=​""​, inplace=​True​)
...
total_confirmed = df_final[​"Confirmed"​].sum() total_recovered = df_final[​"Recovered"​].sum() total_deaths = df_final[​"Deaths"​].sum()
df_top10 = df_total.nlargest(​10​, ​"Confirmed"​) top10_countries_1 = df_top10[​"Country_Region"​].tolist() top10_confirmed = df_top10[​"Confirmed"​].tolist()
...
fig.add_trace(
    go.Indicator(
mode=​"number"​, value=total_confirmed, title=​"Confirmed Cases"​,
),
row=​1​, col=​4 )
fig.add_trace(
    go.Indicator(
...
fig.add_trace(
    go.Indicator(
mode=​"number"​, value=total_deaths, title=​"Deaths Cases"​,
),
row=​1​, col=​6 )
fig.add_trace(
    go.Bar(
...
fig.add_trace(
    go.Bar(
x=top10_countries_2, y=top10_recovered,
name= ​"Recovered Cases"​, marker=dict(color=​"Green"​), showlegend=​True​),
row=​3​, col=​4 )
fig.add_trace(
    go.Bar(
...
str(df_final[​"Last_Update"​][​0​]) + ​")"​, showlegend=​True​, legend_orientation=​"h"​, legend=dict(x=​0.65​, y=​0.8​),
